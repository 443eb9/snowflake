...
export default function MainApp() {
    ...
    const [rightPanelWidth, setRightPanelWidth] = useState(180)
    ...
    return (
        <ShortcutKeyProvider className="w-full h-full">
            ...
            <div className="flex justify-between w-full h-full p-4">
                <div className="flex flex-col overflow-hidden gap-2 justify-between" style={{ width: `${leftPanelWidth}px` }}>
                ...
                <LayoutResizeBar
                    ...
                    size="5px"
                    onResize={val => setLeftPanelWidth(Math.max(180, val))}
                />
                ...
                <LayoutResizeBar
                    ...
                    size="5px"
                    onResize={val => setRightPanelWidth(Math.max(180, val))}
                />
                <div className="flex flex-col gap-2 overflow-hidden" style={{ width: `${rightPanelWidth}px` }}>
